...
public class CrearRadicadoService {
    ...
    public RespuestaGenerica<DocumentoAlmacenado> crearRadicadoGenial(RadicadoGenialDTO radicadoGenialDTO) {
        ...
        try {
            if (Objects.nonNull(radicadoGenialDTO)) {
                ...
                RespuestaGenerica<RadicadoDTO> radicadoDTOContruido = construirDTORadicado(radicadoGenialDTO.getTipoDocumento(), radicadoGenialDTO.getNumeroRadicado(), radicadoGenialDTO.getNumeroContrato(), radicadoGenialDTO.getNumeroRadicado(), validarTaxonomiaCarpetaEmpleado.getObjeto().getIdAzDigital(), validarTaxonomiaCarpetaEmpleado.getObjeto().getIdDeaCodigo(), RadicadoDTO.NivelCreacion.NC, TIPO, new ArrayList<>());
                ...
                RespuestaGenerica<RadicadoDTO> radicadoDTOContruidoRadicado = construirDTORadicado(radicadoGenialDTO.getTipoDocumento(), radicadoGenialDTO.getNumeroRadicado(), radicadoGenialDTO.getNumeroContrato(), radicadoGenialDTO.getNumeroRadicado(), creacionCarpetaContrato.getObjeto().getIdAzDigital(), creacionCarpetaContrato.getObjeto().getIdDeaCodigo(), RadicadoDTO.NivelCreacion.NR, TIPO, new ArrayList<>());
                ...
                RespuestaGenerica<RadicadoDTO> radicadoDTOContruidoDocumentos = construirDTORadicado(radicadoGenialDTO.getTipoDocumento(), radicadoGenialDTO.getNumeroRadicado(), radicadoGenialDTO.getNumeroContrato(), radicadoGenialDTO.getNumeroRadicado(), creacionCarpetaRadicado.getObjeto().getIdAzDigital(), creacionCarpetaRadicado.getObjeto().getIdDeaCodigo(), RadicadoDTO.NivelCreacion.NR, TIPO_DOCUMENTO, radicadoGenialDTO.getDocumentosACargar());
    ...
    private RespuestaGenerica<RadicadoDTO> construirDTORadicado(String tipoDocumento, Integer numeroDocumento, Integer numeroContrato, Integer numeroRadicado, String azCodigo, String deaCodigo, RadicadoDTO.NivelCreacion nivelCreacion, String tipo, List<Documento> documentos) {
        try {
            RadicadoDTO radicadoDTO;
            if (!documentos.isEmpty()) {
                radicadoDTO = new RadicadoDTO(tipoDocumento, numeroDocumento, numeroContrato, azCodigo, deaCodigo, tipo, documentos);
                return new RespuestaGenerica<>(TipoRespuesta.SUCCESS, RADICADO_CONSTRUIDO, radicadoDTO);
            }
            ...
            if (NIVEL_RADICADO.equals(nivelCreacion.name())) {
                radicadoDTO = new RadicadoDTO(tipoDocumento, numeroDocumento, numeroRadicado, azCodigo, deaCodigo, tipo, documentos);
                return new RespuestaGenerica<>(TipoRespuesta.SUCCESS, RADICADO_CONSTRUIDO, radicadoDTO);
            }

            return new RespuestaGenerica<>(TipoRespuesta.ERROR, INC_VAL_CRE_O_COS_RAD.getDescripcion(), INC_VAL_CRE_O_COS_RAD);
    ...
    public RespuestaGenerica<InformacionTaxonomia> validarOCrearTaxonomiaGenial(String tipoDocumento, Integer numeroDocumento, long deaCodigo) {
        Taxonomia taxonomia;
        ...
        try {
            ...
            if (informacionTaxonomia.isEstado()) {
                return new RespuestaGenerica<>(TipoRespuesta.SUCCESS, TAXONOMIA_ENCONTRADA, informacionTaxonomia);
            }
        ...
        try {
            if (Objects.nonNull(radicadoDTO)) {
                ...
                if (!radicadoDTO.getDocumentosACargar().isEmpty() && (!this.validarTamanio(radicadoDTO.getDocumentosACargar()))) {
                    return new RespuestaGenerica<>(TipoRespuesta.ERROR, CodigoError.INC_VAL_ARC_FPO1_ERRN, CodigoError.INC_VAL_ARC_FPO1_ERRN.getDescripcion());
                ...
                if (!creacionCarpetaContrato.getObjeto().isEstado()) {
                    return new RespuestaGenerica<>(TipoRespuesta.ERROR, creacionCarpetaContrato.getMensaje());
                }
                ...
                if (!TipoRespuesta.SUCCESS.equals(crearRadicado.getStatus())) {
                    return new RespuestaGenerica<>(TipoRespuesta.ERROR, crearRadicado.getMensaje());
                }

                // 3. Se valida la taxonomia de la creacion de la carpeta del radicado
                RespuestaGenerica<InformacionTaxonomia> crearCarpetaRadicado = construirTaxonomiaParaCarpeta(new RadicadoDTO(crearRadicado.getValorRetorno(), creacionCarpetaContrato.getObjeto().getIdAzDigital(), creacionCarpetaContrato.getObjeto().getIdDeaCodigo(), radicadoDTO.getNumeroDocumentoEmpleado(), radicadoDTO.getTipoACargar(), RadicadoDTO.NivelCreacion.NR));
                if (!TipoRespuesta.SUCCESS.equals(crearCarpetaRadicado.getStatus())) {
                    return new RespuestaGenerica<>(TipoRespuesta.ERROR, crearCarpetaRadicado.getMensaje());

                }

                // 4. Se construye la taxonomia para los documentos a cargar.
                RespuestaGenerica<DocumentoAlmacenado> cargarDocumentos = construirTaxonomiaParaDocumento(new RadicadoDTO(crearCarpetaRadicado.getObjeto().getIdDeaCodigo(), radicadoDTO.getNumeroDocumentoEmpleado(), TIPO_DOCUMENTO, radicadoDTO.getDocumentosACargar()), crearRadicado.getValorRetorno());
                ...
                return new RespuestaGenerica<>(TipoRespuesta.SUCCESS, crearRadicado.getValorRetorno().toString(), Objects.isNull(cargarDocumentos.getResultadoSubidaDocumentos()) ?
                        ...
                        Objects.isNull(cargarDocumentos.getListaResultados()) ?
                                new ArrayList<>() : cargarDocumentos.getListaResultados());
            }

            // 6. Se controla el error.
            return new RespuestaGenerica<>(TipoRespuesta.ERROR, INC_VAL_CAM_RAD, INC_VAL_CAM_RAD.getDescripcion());

        } catch (RuntimeException e) {
            logger.log(Level.SEVERE, String.format("INC_VAL_GEN%s : crearRadicadoSitioTrabajador", e.getMessage()));
            return new RespuestaGenerica<>(TipoRespuesta.ERROR, INC_VAL_GEN, INC_VAL_GEN.getDescripcion() + e.getMessage());
        }
    }
    ...
    public RespuestaGenerica<DocumentoAlmacenado> cargarDocumento(RadicadoDTO radicadoDTO) {
        ...
        if (Objects.nonNull(radicadoDTO.getNumeroRadicado())) {
            ...
            return construirTaxonomiaParaDocumento(new RadicadoDTO(taxonomiaEncontrada.getObjeto().getIdAzDigital(), taxonomiaEncontrada.getObjeto().getIdDeaCodigo(), radicadoDTO.getDocumentosACargar(), radicadoDTO.getTipoACargar()), radicadoDTO.getNumeroRadicado());
        }
        return new RespuestaGenerica<>(TipoRespuesta.ERROR, INC_VAL_CAM, INC_VAL_CAM.getDescripcion());
    }
    ...
    private RespuestaGenerica<InformacionTaxonomia> validarTaxonomia(RadicadoDTO radicadoDTO) {
        ...
        try {
            ...
            if (Objects.nonNull(radicadoDTO.getNumeroRadicado())) {
                ...
                return new RespuestaGenerica<>(TipoRespuesta.WARNING, INC_VAL_CRE_CAR_DOC.getDescripcion(), informacionTaxonomia);
            }
            return new RespuestaGenerica<>(TipoRespuesta.WARNING, INC_VAL_CAM, INC_VAL_CAM.getDescripcion());
        } catch (RuntimeException e) {
            logger.log(Level.SEVERE, String.format("INC_VAL_TAX%s : validarTaxonomia", e.getMessage()));
            return new RespuestaGenerica<>(TipoRespuesta.ERROR, INC_VAL_TAX, INC_VAL_TAX.getDescripcion() + e.getMessage());
        }
    }
    ...
    private RespuestaGenerica<DocumentoAlmacenado> construirTaxonomiaParaDocumento(RadicadoDTO radicadoDTO, Integer numeroRadicado) {
        ...
        try {
            ...
            new RespuestaGenerica<>(TipoRespuesta.ERROR, INC_VAL_SUB_DOC.getDescripcion() + e);
        }
